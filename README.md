...
1. **Clone the repository**
   ```bash
   git clone https://github.com/yourusername/rightbridge.git
   cd rightbridge
   ```
...
Project Link: [https://github.com/yourusername/rightbridge](https://github.com/yourusername/rightbridge)
